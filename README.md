...
2. [Add data using SQLModel](docs/future_weeks/8_classes_database_2/8-03-insert.md)
3. [Add data to tables with relationships](docs/future_weeks/8_classes_database_2/8-04-insert-multiple.md)
4. [Selecting data from a database with SQLModel](docs/future_weeks/8_classes_database_2/8-05-select.md)
5. [Update data in a database with SQLModel](docs/future_weeks/8_classes_database_2/8-07-update.md)
6. [Delete data from a database with SQLModel](docs/future_weeks/8_classes_database_2/8-06-delete.md)
7. [Reminder: code quality still matters!](docs/future_weeks/8_classes_database_2/8-08-quality.md)
